...
QUESTION_TEXT: dict[str, str] = {
    # structurants
    "vivant": "Est-ce quelque chose de vivant ?",
    "animal": "Est-ce un animal ?",
    "plante": "Est-ce une plante ?",
    "objet": "Est-ce un objet (qu'on peut tenir / utiliser) ?",
    "lieu": "Est-ce plutôt un lieu ?",
    "concept": "Est-ce plutôt un phénomène ?",

    # descriptifs généraux
    "domestique": "Est-ce domestique ?",
    "interieur": "Est-ce plutôt à l'intérieur ?",
    "naturel": "Est-ce naturel ?",
    "technologique": "Est-ce technologique ?",
    "transport": "Sert-il au transport ?",
    "outil": "Est-ce un outil ?",
    "comestible": "Est-ce comestible ?",
    "dangereux": "Est-ce dangereux ?",
    "bruyant": "Est-ce bruyant ?",
    "mobile": "Est-ce mobile ?",
    "vivant_sauvage": "Est-ce un vivant sauvage ?",
    "aquatique": "Est-ce lié à l'eau ?",
    "aerien": "Est-ce lié au ciel / à l'air ?",
    "feu_chaud": "Est-ce lié au feu / au chaud ?",

    # échelles
    "tres_petit": "Tient-il dans la paume d'une main ?",
    "taille": "Est-elle plus grande qu'un humain ?",
    "geant": "Est-ce gigantesque ?",
    "poids": "Est-ce plutôt lourd ?",
    "durete": "Est-ce plutôt dur ?",

    # animaux
    "aboie": "Est-ce que ça aboie ?",
    "miaule": "Est-ce que ça miaule ?",
    "ronronne": "Est-ce que ça ronronne ?",
    "rongeur": "Est-ce un rongeur ?",
    "grimpe_arbres": "Grimpe-t-il aux arbres ?",
    "cage": "Vit-il typiquement en cage ?",
    "ferme": "Est-ce un animal de ferme ?",
    "lait": "Produit-il du lait ?",
    "laine": "Donne-t-il de la laine ?",
    "oeufs": "Pond-il des œufs ?",
    "felin": "Est-ce un félin ?",
    "rayures": "A-t-il des rayures ?",
    "criniere": "A-t-il une crinière ?",
    "taches": "A-t-il des taches ?",
    "vole": "Vole-t-il réellement ?",
    "chante": "Chante-t-il ?",
    "bec": "A-t-il un bec ?",
    "plumes": "A-t-il des plumes ?",
    "nageoires": "A-t-il des nageoires ?",
    "ecailles": "A-t-il des écailles ?",
    "reptile": "Est-ce un reptile ?",
    "carapace": "A-t-il une carapace ?",
    "insecte": "Est-ce un insecte ?",
    "ailes": "A-t-il des ailes d'insecte ?",
    "antennes": "A-t-il des antennes ?",

    # familles
    "fam_mammifere": "Est-ce un mammifère ?",
    "fam_oiseau": "Est-ce un oiseau ?",
    "fam_poisson": "Est-ce un poisson ?",
    "fam_reptile": "Est-ce un reptile ?",
    "fam_insecte": "Est-ce un insecte ?",
    "fam_arachnide": "Est-ce un arachnide ?",
    "fam_amphibien": "Est-ce un amphibien ?",
    "fam_plante": "Est-ce une plante ?",
    "fam_lieu": "Est-ce un lieu ?",
    "fam_objet": "Est-ce un objet ?",
    "fam_concept": "Est-ce un phénomène ?",

    # sous-types objets
    "obj_electronique": "Est-ce un objet électronique ?",
    "obj_mobilier": "Est-ce du mobilier ?",
    "obj_cuisine": "Est-ce lié à la cuisine ?",
    "obj_recipent": "Est-ce un récipient ?",
    "obj_outil_tranchant": "Est-ce un outil tranchant ?",
    "obj_ecriture_papeterie": "Est-ce pour écrire / papeterie ?",
    "obj_instrument_musique": "Est-ce un instrument de musique ?",
    "obj_hygiene": "Est-ce lié à l'hygiène ?",
    "obj_vetement_accessoire": "Est-ce un Vêtement / accessoire ?",
    "obj_audio_video": "Est-ce Audio / vidéo ?",
    "obj_energie_charge": "Est-ce une charge / alimentation ?",
    "obj_mesure_temps": "Une mesure du temps ?",

    # sous-types lieux
    "lieu_nature": "Est-ce un lieu naturel ?",
    "lieu_batiment": "Est-ce un bâtiment / lieu construit ?",
    "lieu_transport": "Est-ce lié au transport ?",
    "lieu_eau": "Est-ce un lieu d'eau (mer/lac/rivière) ?",

    # concepts
    "phenom_meteo": "Est-ce un phénomène météo ?",

    # fonctions d'objet
    "fait_du_son": "Cet objet fait-il du son ?",
    "se_tient_en_main": "Est-ce quelque chose qui se tient en main ?",
    "sert_a_couper": "Sert-il à couper ?",
    "sert_a_lire_ecrire": "Sert-il à lire ou écrire ?",
    "sert_a_manger_boire": "Sert-il à manger ou boire ?",
}
